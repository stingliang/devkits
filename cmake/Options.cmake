...
macro(print_config)
    ...
    message("-- Platform      Target platform              ${CMAKE_SYSTEM_NAME}/${CMAKE_SYSTEM_PROCESSOR}")
    message("------------------------------------------------------------------------")
    message("-- TESTS         Unit tests                   ${TESTS}")
    message("-- DEMO          Libraries usage demo         ${DEMO}")
    message("-- TOOLS         Utility tools                ${TOOLS}")
    message("-- Gui           Compile GUI components       ${WITH_GUI}")
    message("------------------------------------------------------------------------")
endmacro()

macro(print_library_info LIBRARY_NAME LIBRARY_VERSION LIBRARY_PATH)
    message("------------------------------------------------------------------------")
    message("-- Library       ${LIBRARY_NAME}")
    message("-- Version       ${LIBRARY_VERSION}")
    message("-- Path          ${LIBRARY_PATH}")
#    message("------------------------------------------------------------------------")
endmacro()
